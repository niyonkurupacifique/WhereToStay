...
export default function LoginFromAccount() {
  ...
  const handleLoginn = async (e) => {
    ...
    try {
      ...
      const result = await fetch(
        "https://wheretostay.onrender.com/api/auths/login",
        {
          method: "POST",
          body: JSON.stringify({
      ...
      >
        <Box sx={style} className=" w-2/3  rounded-2xl">
          <Typography id="modal-modal-title" variant="h6" component="h2">
            ...
            <span className=" flex justify-center font-txtFontFamily text-loginFontsize font-txtbodyFontWeight leading-loginLineHeight tracking-txtbodyLetterspacing text-txtecolor underline underline-offset-8">
              LogIn
            </span>
          </Typography>
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            <div className=" space-y-4 w-full">
              <div className=" flex space-x-2 rounded-lg w-full  border-black border-2">
                <div className="flex space-x-2 py-1 pl-2">
                  ...
                  <div>
                    {" "}
                    <input
                      style={{ width: "220%", border: "none", outline: "none" }}
                      onChange={(e) => {
                        setEnterYourEmail(e.target.value);
                      }}
                      className="myclass border-none  focus-visible:outline-none focus-visible:border-none  focus:outline-none"
                ...
                <div className="flex  py-1 pl-2 w-full ">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        setEnterYourPassword(e.target.value);
                      }}
              ...
              <div className=" flex space-x-2 justify-center">
                <div className=" font-txtFontFamily text-txtbodyFontsize font-txtbodyFontWeight leading-txtbodylineHeight tracking-txtbodyLetterspacing">
                  Forgot your password?
                </div>
                <button className=" font-txtFontFamily text-txtbodyFontsize font-headerFontWeight leading-txtbodylineHeight tracking-txtbodyLetterspacing text-txtecolor">
                  Set one
                </button>
              </div>
                  ...
                  <div className="flex py-1 px-6 space-x-2  w-64 justify-center">
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className=" border-none mt-3  font-txtFontFamily text-txtbodyFontsize font-headerFontWeight leading-txtbodylineHeight tracking-txtbodyLetterspacing text-white"
                      >
                        Login
                      </button>{" "}
                    </div>
              ...
              <div className=" flex justify-center font-txtFontFamily text-txtbodyFontsize font-txtbodyFontWeight leading-txtbodylineHeight tracking-txtbodyLetterspacing">
                or
              </div>
              <div className=" flex space-x-6 ">
                <div className=" flex space-x-2  border-4  border-txtecolor  rounded-lg">
                  <div className="flex py-1 px-6 space-x-2  w-64 justify-center">
                    ...
                    <div>
                      {" "}
                      <button className=" border-none mt-3  focus:outline-none ">
                        {" "}
                        <span className="whitespace-pre-line font-txtFontFamily text-txtbodyFontsize font-headerFontWeight leading-txtbodylineHeight tracking-txtbodyLetterspacing">
