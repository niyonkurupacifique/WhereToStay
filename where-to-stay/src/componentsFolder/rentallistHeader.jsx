      ...
      <div className="  flex-1 flex  justify-between  mx-8">
        ...
        <div>
          <div className=" flex space-x-6 justify-center items-center">
            <button onClick={()=>{navigate(`/dashboard/${newToken}`);}} className=" text-headerFontSize mt-2 font-headerFontFamily font-headerFontWeight leading-headerLineHeight">
             Landlord dashboard
            </button>
...
export default RentallistHeader;
