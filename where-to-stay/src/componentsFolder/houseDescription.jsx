   ...
   const[houseDescriptionById,setHouseDescriptionById]=useState(null)
    ...
    return (
          <div className=" w-full">
            ...
            <span className=" font-txtFontFamily text-txtbFontsize font-ttttttxtbodyFontWeight leading-tttttttttxtbodylineHeight tracking-txtbodyLetterspacing">More details about this Rental</span> 
            <div className="  ml-52">
                         <button onClick={()=>{setOpen(true);setHouseId(houseId)}} type="button" class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Book Now</button>
                         </div> 
            
            </div>
                {
                  houseDescriptionById&&(<div>
             ...
             <div className=" mt-20 grid grid-cols-2 space-x-5 space-y-3">
               <div>
                   <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[1]} alt="" />
               </div>
               <div>
                   <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[2]} alt="" />
               </div>
               <div>
                   <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[3]} alt="" />
               </div>
               <div>
                   <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[4]} alt="" />
               </div>
               <div>
                <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[1]} alt="" />
               </div>
               <div>
                   <img className="  w-52  h-36" src={houseDescriptionById.imageUrls[0]} alt="" />
               </div>
             </div>
             </div>
             <div className=" ml-40 mt-7 flex space-x-4">
               <div className=" space-y-3">
                   <div>
                       <span className=" ml-7 font-txtFontFamily text-headerFontSize font-headerFontWeight leading-txttttLineHeight tracking-txttttttttttttttttttbodyLetterspacing">Description</span>
                   </div>
                   <div className=" w-96">
                   ...
                   <div>
                       <div>
                           <span  className=" font-txtFontFamily text-headerFontSize font-headerFontWeight leading-txttttLineHeight tracking-txttttttttttttttttttbodyLetterspacing">Address</span>
                       </div>
                   ...
                   <div>
                       <div>
                           <span  className=" font-txtFontFamily text-headerFontSize font-headerFontWeight leading-txttttLineHeight tracking-txttttttttttttttttttbodyLetterspacing">Overview</span>
                       </div>
                       <div   className=" font-txtFontFamily text-txtbodyFontsize font-txtbodyFontWeight leading-txtbodylineHeight tracking-txttttttttttttttttttbodyLetterspacing">
                           <div>
                               <span>Property Type:{houseDescriptionById.property_type}</span>
                           </div>
                           <div>
                               <span>Number of Bedrooms:{houseDescriptionById.number_rooms}</span>
                           </div>
                           <div>
                               <span>Number of bathrooms:{houseDescriptionById.number_of_bathrooms}</span>
                           </div>
                           <div>
                               <span>Price:{houseDescriptionById.price} Rwf per month</span>
                           </div>
                       </div>
                   </div>
                   </div>
             ...
             <div  className=" ml-32  mt-8">
               <div className="">
                   <span  className="  font-txtFontFamily text-headerFontSize font-headerFontWeight leading-txttttLineHeight tracking-txttttttttttttttttttbodyLetterspacing">Contact the Owner</span>
               </div>
               <div className=" flex  pt-4">
                   <div style={{width:'10%',height:'80px'}} className=" mr-5  mt-16 ">
                       <img  className=" " style={{width:'100%'}} src={houseOwner} alt="" />
                   </div>
                   <div className=" mt-24   font-txtFontFamily text-txtbodyFontsize font-txtbodyFontWeight leading-txtbodylineHeight tracking-txttttttttttttttttttbodyLetterspacing">
                           <div>
                               <span>Property Owner:{houseDescriptionById.User.firstName} </span>
                           </div>
                           <div>
